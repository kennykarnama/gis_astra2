...
class ImportFileHandlingArhoJob implements ShouldQueue
{
    ...
    public function handle()
    {
        //
          ...
          DB::table('handling_arho')->truncate();
        ...
        Excel::filter('chunk')->load($this->path)->chunk(250, function($results)
                {
                    ...
                    foreach($results as $row)
                       ...
                       DB::table('handling_arho')->insert($prepared_data);
